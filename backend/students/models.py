...
class Student(models.Model):
    ...
    pending_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, blank=True, null=True)
    fee_status = models.CharField(max_length=50, default='Paid', blank=True, null=True)
    paid_months = models.JSONField(default=list, blank=True, null=True)
    admission_fee = models.DecimalField(max_digits=10, decimal_places=2, default=1000.00, blank=True, null=True)
    admission_fee_paid_amount = models.DecimalField(max_digits=10, decimal_places=2, default=1000.00, blank=True, null=True)
    admission_fee_paid = models.BooleanField(default=True, blank=True, null=True)
